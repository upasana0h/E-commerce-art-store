   ...
   <section class="checkout-orders">
      ...
      <form action="" method="POST">
         ...
         <div class="display-orders">
            ...
            ?>
                  <p> <?= $fetch_cart['name']; ?> <span>(<?= 'Rs ' . $fetch_cart['price'] . '/-' ; ?>)</span> </p>
            <?php
               }
            } else {
         ...
         <div class="flex">
            ...
            <div class="inputBox">
               <span>Location:</span>
               <input type="text" name="street" placeholder="e.g. balkumari" class="box" maxlength="50" required>
            </div>
